                        ...
                        <div class="form-group"> <h4 class="fontedezoito"><b>Dados pessoais</b></h4>
							...
							<div class="row">
								...
								<div class="col-md">
									...
									<input type="password" class="form-control" id="isenha" name="isenha" required pattern="[a-zA-Z0-9]{12}" placeholder="Ex: Senha com letras e números e até 12 caracteres">
								</div>
								<div class="col-md">
