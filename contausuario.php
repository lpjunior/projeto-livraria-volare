            ...
            <!-- Nav pills -->
                ...
                <section class="bordaspraconteudo col-md-8 centraliza mt-1">
                    ...
                    <div class="card">
                        ...
                        <p class="card-text">Utiize este canal de contato para conseguir detalhar sua dúvida,cancelar pedidos e solicitar trocas de produtos. No atendimento por e-mail não poderão ser tratados problemas realacionados a pagamento e nem efetuar a confirmação de seus dados cadastrais.</p>
